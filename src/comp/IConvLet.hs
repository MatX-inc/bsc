...
unpoly i (CmoduleVerilog _ _ _ _ _ _ _ _ _) = internalError "IConv.unpoly: CmoduleVerilog"
...
unpoly i e@(CAnyT {}) = e
unpoly i (CmoduleVerilogT t e ui clks rsts ses xs v p fb) = CmoduleVerilogT t (unpoly i e) ui clks rsts (mapSnd (unpoly i) ses) xs v p fb
