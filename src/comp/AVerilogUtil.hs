...
import Data.List(nub, partition, genericLength, genericIndex, union,
                 uncons, sortBy)
...
import ErrorUtil
import Flags(Flags, readableMux, unSpecTo, v95, systemVerilogOutput, useDPI, stableVerilog)
import PPrint
import IntLit
import Id
...
vForeignBlock vco ffmap ds (clks, fcalls) =
  let
      ...
      inline_def_ids0 = S.toList (S.intersection (S.fromList av_depend_defs)
