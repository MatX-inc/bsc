...
classicWarnExpr (CmoduleVerilog n _ _ _ vargs _ _ _ _) = concatMapM classicWarnExpr (n : map snd vargs)
...
classicWarnExpr (CmoduleVerilogT _ n _ _ _ vargs _ _ _ _) = concatMapM classicWarnExpr (n : map snd vargs)
