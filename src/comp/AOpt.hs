...
import Util(flattenPairs, makePairs, remOrdDup, integerToBits,
            itos, eqSnd, cmpSnd, nubByFst, map_insertManyWith,
            headOrErr, lastOrErr, unconsOrErr)
...
import AOptCase(aExpandDynSel, aInsertCaseDef, rmDupsInCasePairs, isInt)
