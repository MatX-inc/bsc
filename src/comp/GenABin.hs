...
header :: [Byte]
header = B.unpack $ TE.encodeUtf8 $ T.pack "bsc-ba-20260803-4"
...
instance Bin Flags where
    writeBytes (Flags
                ...
                a_130 a_131 a_132 a_133 a_134 a_135 a_136 a_137 a_138 a_139 a_140) =
      ...
      where
        ...
        wr_chunk8 =
          do toBin a_120; toBin a_121; toBin a_122; toBin a_123; toBin a_124;
             ...
             toBin a_130; toBin a_131; toBin a_132; toBin a_133; toBin a_134; toBin a_135; toBin a_136; toBin a_137; toBin a_138; toBin a_139; toBin a_140
    readBytes =
       do (a_000, a_001, a_002, a_003, a_004, a_005, a_006, a_007,
          ...
          (a_120, a_121, a_122, a_123, a_124, a_125, a_126, a_127,
           a_128, a_129, a_130, a_131, a_132, a_133, a_134, a_135, a_136, a_137, a_138, a_139, a_140) <- rd_chunk8
          return (Flags
                a_000 a_001 a_002 a_003 a_004 a_005 a_006 a_007 a_008 a_009
                a_010 a_011 a_012 a_013 a_014 a_015 a_016 a_017 a_018 a_019
                a_020 a_021 a_022 a_023 a_024 a_025 a_026 a_027 a_028 a_029
      ...
      where
        ...
        rd_chunk8 =
          do a_120 <- fromBin; a_121 <- fromBin; a_122 <- fromBin; a_123 <- fromBin; a_124 <- fromBin;
             ...
             a_135 <- fromBin; a_136 <- fromBin; a_137 <- fromBin; a_138 <- fromBin; a_139 <- fromBin; a_140 <- fromBin
             return (a_120, a_121, a_122, a_123, a_124, a_125, a_126, a_127,
                     a_128, a_129, a_130, a_131, a_132, a_133, a_134, a_135, a_136, a_137, a_138, a_139, a_140)
