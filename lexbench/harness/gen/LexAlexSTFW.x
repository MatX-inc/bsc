...
-- Alex-generated Bluespec Classic lexer, strict Text, fast path, interning, ws-comment run-scan input.
...
module LexAlexSTFW(lexAlexStart) where
...
go lf f !l !c s
  ...
  -- after any newline returns to the driver so the directive check runs.
