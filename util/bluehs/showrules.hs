#!/usr/bin/env runghc
-- Script version of showrules: runs against the compiled `bsc` cabal library.
-- Invoke via `cabal exec -v0 -- runghc util/bluehs/showrules.hs ...` (see README.md),
-- or directly as ./showrules.hs once a GHC package environment is set up.
{-# LANGUAGE CPP #-}
