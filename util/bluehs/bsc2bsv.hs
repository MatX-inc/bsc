#!/usr/bin/env runghc
-- Script version of bsc2bsv: runs against the compiled `bsc` cabal library.
-- Invoke via `cabal exec -v0 -- runghc util/bluehs/bsc2bsv.hs ...` (see README.md),
-- or directly as ./bsc2bsv.hs once a GHC package environment is set up.
